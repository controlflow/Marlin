...
#define CUSTOM_MACHINE_NAME "UlTi Steel v1.1"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 413.31 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 6.5, 100 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_FEEDRATE 6.5      // (mm/s) Z axis feedrate (not used for delta printers)
#endif
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_COLOR { 255, 0, 0, 0 } // R, G, B, W
#endif
